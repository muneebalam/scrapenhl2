...
(Sometimes, this errors out and says you need Visual Studio C++ tools. You can download and install 
`from here <https://landinghub.visualstudio.com/visual-cpp-build-tools>`_ (2015 version).)
